...
class PIBITIClient(object):
    ...
    def __init__(self, baseUrl, keyFile=None):
        ...
        self._address = _hash(FAMILY_NAME.encode('utf-8'))[0:6] + _hash(CPF.encode('utf-8'))[0:64]
    ...
    def _wrap_and_send(self):
        ...
        rawPayload = 'add,000.000.000-00,jorge'
...
def main():
    ...
    iot_cli = PIBITIClient(baseUrl=DEFAULT_URL, keyFile=key_file)
    response = iot_cli._wrap_and_send()
